...
$('.waifu-tool .fui-home').click(function (){
   ...
   //  window.location = window.location.protocol+'//'+window.location.hostname+'/'
    window.location = 'https://atri.wiki/home'
...
$('.waifu-tool .fui-chat').click(function (){
   // 去关于我的界面
   //  window.location = window.location.protocol+'//'+window.location.hostname+'/'
    window.location = 'https://atri.wiki/about'
...
$('.waifu-tool .fui-info-circle').click(function (){
    showMessage('想知道我的更多信息吗？~~~',1000, true);
    window.open('https://github.com/duanyhui');
...
(function (){
    var text;
    var SiteIndexUrl = 'https://atri.wiki/home';  // 手动指定主页
