package atri.wiki.util.quartz;

import atri.wiki.entity.ScheduleJobLog;
import atri.wiki.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		atri.wiki.entity.ScheduleJob scheduleJob = (atri.wiki.entity.ScheduleJob) context.getMergedJobDataMap().get(atri.wiki.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
