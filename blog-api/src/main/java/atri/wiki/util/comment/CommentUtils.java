package atri.wiki.util.comment;

import atri.wiki.config.properties.BlogProperties;
import atri.wiki.constant.PageConstants;
import atri.wiki.entity.User;
import atri.wiki.enums.CommentOpenStateEnum;
import atri.wiki.enums.CommentPageEnum;
import atri.wiki.model.dto.Comment;
import atri.wiki.model.vo.FriendInfo;
import atri.wiki.util.HashUtils;
import atri.wiki.util.IpAddressUtils;
import atri.wiki.util.StringUtils;
import atri.wiki.util.comment.channel.ChannelFactory;
import atri.wiki.util.comment.channel.CommentNotifyChannel;
import atri.wiki.service.*;
...
import atri.wiki.util.MailUtils;
import atri.wiki.util.QQInfoUtils;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, atri.wiki.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(atri.wiki.entity.Comment parentComment, Comment comment) {
