...
public class BlogAdminController {
	...
	public Result blogs(@RequestParam(defaultValue = "") String title,
		...
		PageInfo<atri.wiki.entity.Blog> pageInfo = new PageInfo<>(blogService.getListByTitleAndCategoryId(title, categoryId));
	...
	public Result getBlog(@RequestParam Long id) {
		atri.wiki.entity.Blog blog = blogService.getBlogById(id);
