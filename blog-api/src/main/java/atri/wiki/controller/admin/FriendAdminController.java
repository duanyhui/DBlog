package atri.wiki.controller.admin;
...
public class FriendAdminController {
	...
	public Result friends(@RequestParam(defaultValue = "1") Integer pageNum,
		...
		PageInfo<atri.wiki.entity.Friend> pageInfo = new PageInfo<>(friendService.getFriendList());
	...
	@PostMapping("/friend")
	public Result saveFriend(@RequestBody atri.wiki.entity.Friend friend) {
