...
import atri.wiki.exception.NotFoundException;
...
import atri.wiki.mapper.BlogMapper;
...
import atri.wiki.task.RedisSyncScheduleTask;
import atri.wiki.util.JacksonUtils;
import atri.wiki.util.markdown.MarkdownUtils;
...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public List<atri.wiki.entity.Blog> getListByTitleAndCategoryId(String title, Integer categoryId) {
	...
	@Override
	public List<atri.wiki.entity.Blog> getIdAndTitleList() {
	...
	@Override
	public atri.wiki.entity.Blog getBlogById(Long id) {
		atri.wiki.entity.Blog blog = blogMapper.getBlogById(id);
		if (blog == null) {
