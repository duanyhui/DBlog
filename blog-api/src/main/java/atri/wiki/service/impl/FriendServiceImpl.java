...
import atri.wiki.entity.SiteSetting;
import atri.wiki.mapper.FriendMapper;
import atri.wiki.mapper.SiteSettingMapper;
import atri.wiki.model.vo.FriendInfo;
import atri.wiki.service.FriendService;
...
public class FriendServiceImpl implements FriendService {
	...
	@Override
	public List<atri.wiki.entity.Friend> getFriendList() {
		return friendMapper.getFriendList();
	}

	@Override
	public List<atri.wiki.model.vo.Friend> getFriendVOList() {
	...
	@Transactional
	@Override
	public void saveFriend(atri.wiki.entity.Friend friend) {
		friend.setViews(0);
